...
int main(const int argc, const char** argv) {
  ...
  particle.x  = (float*) _mm_malloc(sizeof(float)*nParticles,32);
  particle.y  = (float*) _mm_malloc(sizeof(float)*nParticles,32);
  particle.z  = (float*) _mm_malloc(sizeof(float)*nParticles,32);
  particle.vx = (float*) _mm_malloc(sizeof(float)*nParticles,32);
  particle.vy = (float*) _mm_malloc(sizeof(float)*nParticles,32);
  particle.vz = (float*) _mm_malloc(sizeof(float)*nParticles,32);
